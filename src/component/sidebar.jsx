      ...
      <div className="">
        <div onClick={() => setShowSidebar(!showSidebar)} className="pt-5 z-50">
          <img
            ...
            src="https://upload.wikimedia.org/wikipedia/commons/thumb/b/b2/Hamburger_icon.svg/108px-Hamburger_icon.svg.png"
            width="20px"
            height="20px"
            id="lefticon"
          />
        ...
        <Link to="/">
          <div className="pt-8 sm:block hidden">
            <img
        ...
        <Link to="/shorts">
          <div className="pt-6 sm:block hidden">
            <img
          ...
          <div className="pt-5  fixed w-full z-50">
            ...
            <div className="flex">
              <img
                ...
                id="lefticon"
              />
              <div className="ml-7 w-[90px] h-[18px] sm:block hidden">
                <img
            ...
            <div className="pt-8 mx-4 sm:mx-6">
              {slidebarData.map((e) => {
                return (
                  <div>
                    <Link to={e.route}><div
                    onClick={()=>setShowSidebar(!showSidebar)}
                      className={` flex hover:bg-[#f2f2f2] py-2.5 sm:px-2 px-1 rounded-[15px]`}
                    >
                      <div className="">
                        <img
                          className=""
                      ...
                      <p className="hidden sm:block text-[14px] focus:font-medium ml-3 w-[80%] align-middle my-auto">
                        {e.title}
                      </p>
                    </div></Link>
