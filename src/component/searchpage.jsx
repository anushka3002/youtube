      ...
      <p>Filters</p>
        ...
        return(
          <div className=' flex w-[100%]'>
            {loader ?  <div className='w-[40%] mb-4'>
            <Skeleton height="190px" width="full"/>
            </div>:<div className='w-[30%] mb-4'>
            <Link to="/videopage"><img onClick={()=>handleClick(e)} className='h-[190px] w-full object-cover rounded-[14px]' src={e.snippet.thumbnails.high.url}></img></Link>
            </div>}
            {loader?<div className='ml-2 w-full'>
